...
ALLOWED_HOSTS = ["bookstore-lugres.fly.dev", "localhost", "127.0.0.1"]
CSRF_TRUSTED_ORIGINS = ["https://bookstore-lugres.fly.dev"]
# ALLOWED_HOSTS = []
...
# Additional security settings before going into prod
